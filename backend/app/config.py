...
class Settings(BaseSettings):
    ...
    # The coaching intelligence IS the product, so chat runs on the most capable model
    # (Opus 4.8) for genuinely good routine revisions, not the cheaper Sonnet. Cost is the
    # secondary concern here (see the AI-spend panel to monitor it).
    chat_model: str = "claude-opus-4-8"
    # Weekly review, dashboard summary, and notes also run on Opus.
